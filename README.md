...
| 01     | [Born2beroot](./01_born2beroot)                                                 | Shell       | `Virtual machine` <br /> `Linux` `SSH` <br /> `Network & System administration` <br /> `Firewall` `Shell scripte`                 | 577       | [![dpetrosy's 42 Born2beroot Score](https://badge42.vercel.app/api/v2/cl2yuh8s9004909jwelgj2fud/project/2563283)](https://github.com/JaeSeoKim/badge42)       |  2 - 14%           |
